            ...
            <div class="bgc-white p-20 bd">
                ...
                <fieldset class="col-md-12">
                    ...
                    <div class="row">
                        <x-form.input name="cpf" title="CPF" class="optional col-md-3"
                                      placeholder="só numeros" :value="$client->cpf??''"
                                      inputClass="cpf"></x-form.input>
                        <x-form.input name="name" title="Nome" class="col-md-2" :value="$client->name??''"
                                      required></x-form.input>
                        <x-form.input name="last_name" title="Sobrenome" class="col-md-4"
                                      :value="$client->last_name??''" required></x-form.input>
                        ...
                        <x-form.input type="email" class="col-md-5 email" name="email" title="E-mail"
                                      :value="$client->email??''"></x-form.input>
                        <x-form.input class="col-md-3" title="Telefone" name="tel0" inputClass="tel"
                                      :value="$client->tel0??''"></x-form.input>
                ...
                <fieldset class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <x-form.input name="recommendation" title="Recomendação" class="col-md-2"
                                      :value="$client->recommendation->name??''"></x-form.input>
                    </div>
                </fieldset>
